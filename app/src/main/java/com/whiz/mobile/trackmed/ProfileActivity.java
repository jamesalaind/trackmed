...
import com.whiz.mobile.trackmed.navfragments.FilingsFragment;
import com.whiz.mobile.trackmed.navfragments.ProfileFragment;
import com.whiz.mobile.trackmed.navfragments.SubordinatesFragment;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.whiz.mobile.trackmed.R.layout.activity_profile);

        final Toolbar toolbar = (Toolbar) findViewById(com.whiz.mobile.trackmed.R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        // Set up the ViewPager with the sections adapter.
        mViewPager = (ViewPager) findViewById(com.whiz.mobile.trackmed.R.id.container);
        setupViewPager(mViewPager);

        mTabLayout = (TabLayout) findViewById(com.whiz.mobile.trackmed.R.id.tabs);
        ...
        collapsingToolbarLayout = (CollapsingToolbarLayout) findViewById(com.whiz.mobile.trackmed.R.id.collapsing_toolbar);
        collapsingToolbarLayout.setTitleEnabled(false);
        collapsingToolbarLayout.setTitle("");
        getSupportActionBar().setTitle("");
        tvProfileName = (TextView) findViewById(com.whiz.mobile.trackmed.R.id.tvProfileName);
        tvCompanyName = (TextView) findViewById(com.whiz.mobile.trackmed.R.id.tvCompanyName);

        final AppBarLayout l = (AppBarLayout) findViewById(com.whiz.mobile.trackmed.R.id.app_bar_layout);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(com.whiz.mobile.trackmed.R.menu.activity_profile, menu);
